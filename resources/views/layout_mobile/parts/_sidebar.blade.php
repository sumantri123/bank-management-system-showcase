					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col px-0 align-self-center">								
								<p class="mb-1">{{Session::get('panggilan') ?? "--"}}</p>
								<p class="text-muted size-12">{{Session::get('kota')}}</p>
							</div>
							<div class="col-auto">
								<a href="/logoutMobile" class="btn btn-44 btn-light" >
		...
		<div class="row">
			<div class="col-12">
				<ul class="nav nav-pills">
					...
					<li class="nav-item">
						<a class="nav-link" href="/logoutMobile" tabindex="-1">
