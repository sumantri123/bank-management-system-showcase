...
<div class="card border-top border-0 border-4 border-success" id="headerJB">
    <div class="card-body" >                
        ...
        <form class="form-horizontal form-label-left" id="formEntry" method="post">    
            @csrf     
            <div class="mb-3">
                <label class="form-label"><b>Tanggal Posisi Rek Perantara: </b></label>
    ...
    <div class="card-body" >
        <div class="toolbar hidden-print">
            <div class="text-end">
                ...
                <button type="button" id="btn_print" class="{{$data['btnDarkClass']}}"><i class="bx bxs-printer"></i> Print</button>                
            </div>
            <hr/>
        </div>
...
<script src="{{ asset('additional/js/lap_mon_rek_perantara.js') }}"></script>
