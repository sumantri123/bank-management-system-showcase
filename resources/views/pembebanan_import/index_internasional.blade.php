                                ...
                                <div class="border p-3 rounded">
                                    ...
                                    <div class="row form_custom"> 
                                        <div class="col-sm-12">                                                                                                                                                                    
                                            ...
                                            <div class="row"> 
                                                <div class="col-md-4">
                                                    <label for="inputCity" class="form-label" style="color:blue; font-weight:bold">Nilai L/C</label>
    ...
    <div class="card-body" >
        ...
        <div id="myModalHorizontalprint">
            ...
            <div class="table-responsive">
                <table id="tableContent" class="table mb-0" style="margin-left:20px">
                    <tbody>
                        <tr>
                            <td width="10%">I.</td>
                            <td>NILAI SET.JAM L/C YANG DIBUKA</td>
                            <td width="5%"></td>
                            <td width="5%">USD</td>
                        ...
                        <tr>
                            <td>II.</td>
                            <td>NILAI SET.JAM L/C YANG DIBUKUKAN</td>
                            <td>D</td>                        
                            <td>USD</td>
                        ...
                        <tr>
                            <td>III.</td>
                            <td>KOMISI L/C IMPORT <span id="data_IV_0"></span></td>
                            <td>K</td>
                            <td>USD</td>
                        ...
                        <tr>
                            <td>VI.</td>
                            <td>JUMLAH YANG DIBAYAR IMPORTIR</td>
                            <td>K</td>
                            <td>USD</td>
...
<script src="{{ asset('additional/js/pembebanan_import_inter.js?v=1.03') }}"></script>