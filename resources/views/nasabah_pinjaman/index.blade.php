                    ...
                    <div id="error-validation"></div>                                        
                        <div class="card">
                            ...
                            <div class="card-title d-flex align-items-center">
                                    ...
                                    <div class="row">                                        
                                        <div class="col-4">
                                            <label for="inputCity" class="form-label">Jenis Pinjaman</label>
                                        </div>     
                                        <div class="col-8">
                                            <label for="inputCity" class="form-label">No Rekening</label>										
                                        </div>     
                                        <div class="col-md-4">                                        
                                                <select class="{{$data['classFormSelect']}}" onchange="getval(this);" name="jenis_pinjaman" id="jenis_pinjaman">
                                                    <option value=""></option>
                                                    @foreach($LJenisPinjaman as $jenisPinjaman)
                                                    <option value="{{ $jenisPinjaman->pinjaman_id }}" >{{ ucfirst(trans($jenisPinjaman->pinjaman_nama)) }}</option>
                                                    @endforeach                                                                                                    
                                                </select>
                                        ...
                                        <div class="col-md-2">                                        
                                            <input type="text" class="{{$data['classFormControl']}}" id="no_rekening_3" value="1" name="no_rekening_3" placeholder="1" readonly>
                                            <label for="no_rekening_2" generated="true" class="error"></label>
                                            <label id="validationError"></label>
                                        </div>
                                        <div class="col-12">
					<label for="inputCity" class="form-label">Customer Numbe1r</label>
                                            ...
                                            @else
                                                <select class="{{$data['classFormSelect2']}}" name="customer_number" id="customer_number">
                                                    <option value=""></option>
                                                    @foreach($LNasabahIndividu as $nasabahIndividu)
                                                    <option value="{{ $nasabahIndividu->id }}" >{{ $nasabahIndividu->cif.' - '.ucfirst($nasabahIndividu->nama) }}</option>
                                                    @endforeach                                                                                                    
                                                </select>
                                            @endif
                                        ...
                                        <div class="col-md-8">                                        
                                            ...
                                            <select class="{{$data['classFormSelect']}}" name="sandi_pemilik" id="sandi_pemilik">
                                                <option value=""></option>
...
<script src="{{ asset('additional/js/nasabah_pinjaman.js?v=1.00') }}"></script>
