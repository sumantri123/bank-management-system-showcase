											...
											<div class="col-sm-12">																
												<div class="card radius-10 bg-primary">
													<div class="card-body">
														<div class="d-flex align-items-center">
															<div>                                                                                
																<p class="mb-0 text-white">Tagihan Bulan Ini : </p>
																<h4 class="my-1 text-white"><span id="tagihan_bulan_ini"></span></h4>
																<input type="hidden" class="{{$data['classFormControl']}}" id="tagihan" value="" name="tagihan">
															</div>
...
<script src="{{ asset('additional/js/angsuran_kk.js') }}"></script>
