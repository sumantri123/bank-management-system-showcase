...
<div class="card border-top border-0 border-4 border-success" id="headerJB">
    <div class="card-body" >                
        ...
        <form class="form-horizontal form-label-left" id="formEntry" method="post">    
            ...
            <div class="mb-3">
                <label class="form-label"><b>Jangka Waktu : </b></label>
                ...
                <input type="hidden" class="{{$data['classFormControl']}}" id="no_rekening_1" value="" name="no_rekening_1"  readonly>
...
<script src="{{ asset('additional/js/lap_nasabah_deposito.js') }}"></script>
