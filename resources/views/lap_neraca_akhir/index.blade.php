...
<div class="card border-top border-0 border-4 border-success" id="contentJB">
    <div class="card-body" >
        ...
        <div id="myModalHorizontalprint" style="margin:10px">
            ...
            <div class="row">
				<input type="hidden" class="{{$data['classFormControl']}} disabled" id="matauang" value="{{ session('mataUang') }}" name="matauang">
                <div class="col-sm-6">
                    <div class="form_custom1" id="show_table_left"></div>
                </div>        
                <div class="col-sm-6">
                    <div class="form_custom1" id="show_table_right"></div>
                </div>        
            </div>
       </div>
    </div>
...
<script src="{{ asset('additional/js/lap_neraca_akhir.js?v=1.02') }}"></script>
