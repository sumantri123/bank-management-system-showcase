        ...
        <form class="form-horizontal form-label-left" id="formEntry" method="post">    
            ...
            @else
                <select class="{{$data['classFormSelect2']}} clear" name="id_rekening2" id="id_rekening2" >
                    ...
                    <option value="{{ $nasabahIndividu->id }}" >{{ $nasabahIndividu->nomor_rekening.' - '.ucfirst(trans($nasabahIndividu->nama)) }}</option>
                    @endforeach                                                                                                    
                </select>                                                                
            @endif
...
<div class="card border-top border-0 border-4 border-success" id="contentJB">
    <div class="card-body" >
        ...
        <div id="myModalHorizontalprint" style="margin:10px">
			...
			<table width="100%">
				<tr>
					<td width="25%" ><label class="form-label">Nama</label></td>
					<td width="25%" ><label class="form-label"><span id="namaNasabah"></span></label></td>
					<td width="25%" ><label class="form-label">No. Kartu Kredit</label></td>
					<td width="25%" ><label class="form-label"><span id="noCC"></span></label></td>					
				</tr>
				<tr>
					<td><label class="form-label">Tanggal Pencetakan</label></td>
					<td><label class="form-label"><?php echo date('d-m-Y')?></label></td>
					<td><label class="form-label">Batas Kredit</label></td>
					<td><label class="form-label"><span id="batasKredit"></span></label></td>					
				</tr>
				<tr>
					<td><label class="form-label">Tanggal Jatuh Tempo</label></td>
					<td>
						<label class="form-label">
							<?php 
								$time_sekarang = time();
								$batasPinjam = date("m-Y", strtotime("+1 month", $time_sekarang));			
								echo "11-".$batasPinjam
							?>
						</label>
					</td>
					<td><label class="form-label">Sisa Kredit</label></td>
					<td><label class="form-label"><span id="sisaKredit"></span></label></td>
					<td></td>
				</tr>
			</table>            
            <hr/>
...
<script src="{{ asset('additional/js/lap_tagihan_cc.js') }}"></script>
