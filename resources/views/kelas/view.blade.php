            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal form-label-left" id="form" method="post">
                    <div class="modal-body">                
                        ...
                        <input type="hidden" class="form-control" id="id_user" value="" name="id_user">                
                                        ...
                                        <div class="invoice">	 		
                                            <div class="row form_custom">	
                                                <div class="col-12">
                                                    ...
                                                    <input type="password" class="{{$data['classFormControl']}}" id="password" name="password" >
...
<script src="{{ asset('additional/js/kelas_user.js') }}"></script>
