			...
			<ul class="nav nav-pills nav-justified tabs mb-3" id="assetstabs" role="tablist">				
				<li class="nav-item" role="presentation">
					<button class="nav-link active" id="currency-tab" data-bs-toggle="tab" data-bs-target="#tagihan"
						type="button" role="tab" aria-controls="tagihan" aria-selected="false">Tagihan PDAM</button>
				</li>
			</ul>
							...
							<div class="card shadow-sm mb-2">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col">
											<p class="text-muted size-12 mb-0">Masukkan Jumlah Tagihan PDAM</p>
...
@push('scripts')	
	<script src="{{ asset('additional/js/mobileBanking/pdam/pdam.js?v=1.00') }}"></script>	
@endpush  