		...
		<form class="was-validated needs-validation" id="formSimpan">@csrf			
			...
			<div class="form-floating mb-3">			
				<?php 
					$date = date('F Y');
				?>
				<select class="form-control" id="jangkaWaktu" name="jangkaWaktu">						
					
					<option value="{{base64_encode(Session::get('3XXDERU1_ID').'|4.25|'.Session::get('3XXDERU1').'|'.Session::get('309RPDEP_ID'))}}">1 Bulan 4.25% Pertahun</option>
					<option value="{{base64_encode(Session::get('3XXDERU3_ID').'|4.25|'.Session::get('3XXDERU3').'|'.Session::get('309RPDEP_ID'))}}">3 Bulan 4.25% Pertahun</option>
					<option value="{{base64_encode(Session::get('3XXDERU6_ID').'|4.50|'.Session::get('3XXDERU6').'|'.Session::get('309RPDEP_ID'))}}">6 Bulan 4.50% Pertahun</option>
					<option value="{{base64_encode(Session::get('3XXDER12_ID').'|5.25|'.Session::get('3XXDER12').'|'.Session::get('309RPDEP_ID'))}}">12 Bulan 5.25% Pertahun</option>
...
@push('scripts')	
	<script src="{{ asset('additional/js/mobileBanking/deposito/deposito.js?v=1.01') }}"></script>	
@endpush  