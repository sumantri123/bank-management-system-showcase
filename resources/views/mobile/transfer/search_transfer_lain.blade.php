	...
	<div class="main-container container">
		...
		<div class="row mb-3">
			...
			<div class="col-auto align-self-center">
				<a href="{{Route('tambahRekeningLain')}}" class="small">Tambah Rek Transfer</a>
			</div>
		</div>
		<div class="row">
			<div class="col">
		...
		<div class="row mb-4">
			<div class="col-12 ">
				<a href="{{Route('tambahRekeningLain')}}" class="btn btn-default btn-lg shadow-sm w-100">
...
@push('scripts')	
	<script src="{{ asset('additional/js/mobileBanking/transfer/search_rekening_lain.js') }}"></script>	
@endpush  