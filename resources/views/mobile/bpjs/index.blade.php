		...
		<form class="was-validated needs-validation" id="formSimpan">@csrf
			<div class="card shadow-sm mb-4">
				...
				<div class="card theme-bg text-white border-0 text-center">
					<div class="card-body">
						...
						<p class="text-muted mb-2">Masukkan No. Anggota</p>
					</div>
				</div>
			</div>
			<!-- swiper credit cards -->
			...
			<ul class="nav nav-pills nav-justified tabs mb-3" id="assetstabs" role="tablist">				
				<li class="nav-item" role="presentation">
					<button class="nav-link active" id="currency-tab" data-bs-toggle="tab" data-bs-target="#tagihan"
						type="button" role="tab" aria-controls="tagihan" aria-selected="false">Tagihan BPJS Kesehatan</button>
				</li>
			</ul>
			<div class="tab-content" id="assetstabsContent">				
				<div class="tab-pane fade show active" id="tagihan" role="tabpanel" aria-labelledby="currency-tab">
							...
							<div class="card shadow-sm mb-2">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col">
											<p class="text-muted size-12 mb-0">Masukkan Jumlah Pembayaran BPJS Kesehatan</p>
...
@push('scripts')	
	<script src="{{ asset('additional/js/mobileBanking/bpjs/bpjs.js?v=1.00') }}"></script>	
@endpush  