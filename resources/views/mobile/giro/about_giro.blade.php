	...
	<div class="main-container container">
		...
		<div class="row mb-4 py-4 position-relative bg-dark text-white">
			...
			<div class="col-11 col-md-6 col-lg-4 mx-auto align-self-center">
				<h2 class="text-center mb-2">Buka Rekening Giro</h2>
				<p class="text-center mb-4">Kelola Uang Anda dengan Mudah dan Aman dengan Rekening Giro!</p>                   
			</div>
		</div>
					...
					<div class="accordion-item">
						...
						<div id="flush-collapseOne" class="accordion-collapse collapse show"
							...
							<div class="accordion-body text-muted">
								<span class="heading">Buka Rekening Giro Untuk Semua Bisnis Anda</span>								
								<p class="text-muted small">Rekening Giro dari {{Session::get('nama_bank')}} adalah partner terbaik untuk setiap transaksi Anda. Kami memahami pentingnya kelancaran dan keamanan dalam setiap transaksi keuangan, baik untuk kebutuhan sehari-hari maupun bisnis.</p>
		...
		<div class="row h-100 ">
			<div class="col-12 mb-4">
				...
				<a href="{{Route('setoranAwalGiro')}}" id="btnLanjut2" class="btn btn-default btn-lg w-100">Lanjut</a>
			</div>
		</div>
	</div>
