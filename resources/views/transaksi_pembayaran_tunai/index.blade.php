                                ...
                                <div class="border p-3 rounded">
                                    <div class="row form_custom"> 
                                        ...
                                        <div class="col-sm-6">                                                                                                                        
                                            ...
                                            @else
                                                <select class="{{$data['classFormSelect2']}} clearDisable" onchange="getval(this);" name="id_rekening2" id="id_rekening2" >
                                                    <option value=""></option>
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <select class="{{$data['classFormSelect3']}} clearDisable" onchange="getval2(this);" name="id_kode_transaksi" id="id_kode_transaksi" width="100%">
                                                        <option value=""></option>
                                                        @foreach($LKodeTransaksi as $kodeTransaksi)
                                                        <option value="{{ $kodeTransaksi->id }}" >{{ $kodeTransaksi->kode_transaksi.' - '.ucfirst(trans($kodeTransaksi->nama_transaksi)) }}</option>
                                                        @endforeach                                                                                                    
                                                    </select>
                                                    <input type="hidden" class="{{$data['classFormControl']}}" id="kode_transaksi" value="" name="kode_transaksi" >
                                                    <label for="id_kode_transaksi" generated="true" class="error"></label>
                                                    <label id="validationError"></label>
                                                </div>
                                            </div>
...
<script src="{{ asset('additional/js/transaksi_pembayaran_tunai.js') }}"></script>
