...
class GiroController extends Controller
{
    ...
    {						            
		$data = array(   
			'img' => 'pemandangan_2.jpg',     			    												
        );
		return view($this->view.'about_giro', compact('data'));
    }
    ...
    {						
		...
		$jenisRekening = 1;
		$keterangan = "Setoran Awal Giro Dari Rekening ".$noRekAsal." (Buka Rekening Giro : ".$nomorRekening.")";
	...
	public function successGiro($param)
    {							
        $data = array(            
			'param' => ($param),   
		...
		return view($this->view.'success_giro', compact('data'));
    }
}
